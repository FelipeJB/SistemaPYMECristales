...
@section('titulo', 'Registrar Instalador')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Crear Instalador</li>
          </ol>

          <h2 class="section-title">Crear Instalador</h2>
          <p class="section-subtitle">Ingrese los campos para registrar un nuevo instalador.</p><br>
          ...
          <form method="POST" action="/CrearInstalador">
              @csrf
