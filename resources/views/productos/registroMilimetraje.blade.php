...
@section('titulo', 'Agregar Milimetraje')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Agregar Milimetraje</li>
          </ol>

          <h2 class="section-title">Agregar Milimetraje</h2>
          <p class="section-subtitle">Ingrese el número del nuevo milimetraje.</p><br>
          ...
          <form method="POST" action="/CrearMilimetraje">
              @csrf
