...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
          ...
          <h2 class="section-title">Consultar Estado de Venta</h2>
          <p class="section-subtitle">Ingrese el número de orden para consultar el estado de la venta.</p><br>
          ...
          <form method="POST" action="/ConsultarVenta">
              @csrf
