        ...
        <div class="col-md-12">
          ...
          <div class="row mb-0">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="progress">
                  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="{{$estado->stdID/4}}" aria-valuemin="0" aria-valuemax="1" style="width: {{($estado->stdID/4)*100}}%"></div>
                </div>
              </div>
          </div>
